...
public class _13_IFrameTest extends Base{
   ...
   /*
    ...
    public void validateTheFormSubmission(){
        ...
        WebElement submission = driver.findElement(By.id("result"));
        Assert.assertTrue(submission.isDisplayed());
        Assert.assertEquals(submission.getText(), "You entered: John Doe");
